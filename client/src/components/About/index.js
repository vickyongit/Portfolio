...
I began my journey driven by the desire to build — not just interfaces, but seamless digital experiences. Over time, I’ve grown into a full stack developer with strong roots in the MERN stack and Python.

On the front end, I craft interactive, responsive UIs using React. On the back end, I design scalable APIs with Node.js and Express, and work with MongoDB or SQLite for efficient data handling. Python adds flexibility to my toolkit — for scripting, backend logic, or solving complex problems with clarity.

Self-taught, self-driven, and always improving. I write code to build, to learn, and to grow.
